...
% features extraction
[feats1HK, valid_points1_HK]=extractFeatures(I1gray,sorted_blobs1,'Method','SURF');
[feats2HK, valid_points2_HK]=extractFeatures(I1gray_R,sorted_blobs2,'Method','SURF');
...
filter=abs(matchedPoints1_HK.Location(:,1)-matchedPoints2_HK.Location(:,1))<0.1;
